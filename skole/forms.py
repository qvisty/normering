    ...
    class Meta:
        ...
        widgets = {
            "name": forms.TextInput(
                attrs={"class": "form-control", "placeholder": "Indtast skolens navn"}
            ),
        }
        labels = {
            "name": "Skolens Navn",
    ...
    class Meta:
        ...
        widgets = {
            "name": forms.TextInput(
                attrs={
                    "class": "form-control",
                    "placeholder": "Indtast afdelingens navn",
                }
            ),
...
class TeamForm(forms.ModelForm):
    class Meta:
        ...
        widgets = {
            "name": forms.TextInput(
                attrs={"class": "form-control", "placeholder": "Indtast teamnavn"}
            ),
    ...
    class Meta:
        ...
        widgets = {
            "name": forms.TextInput(
                attrs={
                    "class": "form-control",
                    "placeholder": "Indtast kategoriens navn",
                }
            ),
            "type": forms.TextInput(
                attrs={
                    "class": "form-control",
                    "placeholder": "Indtast kategoriens type",
                }
            ),
    ...
    class Meta:
        ...
        widgets = {
            ...
            "subject": forms.TextInput(
                attrs={"class": "form-control", "placeholder": "Indtast fag"}
            ),
            "classroom": forms.TextInput(
                attrs={"class": "form-control", "placeholder": "Indtast lokale"}
            ),
...
class SchoolFeeForm(forms.ModelForm):
    class Meta:
        ...
        widgets = {
            "name": forms.TextInput(
                attrs={"class": "form-control", "placeholder": "Indtast takstens navn"}
            ),
...
class StudentForm(forms.ModelForm):
    class Meta:
        ...
        widgets = {
            "name": forms.TextInput(
                attrs={"class": "form-control", "placeholder": "Indtast elevens navn"}
            ),
            "schoolclass": forms.Select(attrs={"class": "form-control"}),
            "age_number": forms.NumberInput(attrs={"class": "form-control"}),
